...
object Nbt : BinaryFormat {
	...
	inline fun <reified T> encodeToNbt(value: T): TagAny = encodeToNbt(serializer(), value)
	...
	inline fun <reified T> decodeFromNbt(tag: TagAny): T = decodeFromNbt(serializer<T>(), tag)
